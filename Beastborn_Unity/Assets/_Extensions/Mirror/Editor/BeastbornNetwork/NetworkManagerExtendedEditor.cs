...
{
    [CustomEditor(typeof(NetworkManagerExtended), true)]
    [CanEditMultipleObjects]
    public class NetworkManagerExtendedEditor : Editor
    {
        SerializedProperty spawnListProperty;
        ReorderableList spawnList;
        protected NetworkManagerExtended networkManager;

        protected void Init()
        {
            if (spawnList == null)
            {
                networkManager = target as NetworkManagerExtended;
