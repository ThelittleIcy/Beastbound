...
namespace Mirror
{
    ...
    public struct AddVRPlayerMessage : NetworkMessage {}

    public struct AddFSPlayerMessage : NetworkMessage {}

    public struct ConnectionGotDeclinedLobbyFullMessage : NetworkMessage {}
